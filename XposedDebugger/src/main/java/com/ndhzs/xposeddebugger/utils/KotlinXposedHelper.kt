...
/*
 * 本文件来自：https://github.com/yujincheng08/BiliRoaming
 */
...
infix fun ClassLoader.find(name: String?): Class<*> = findClass(name, this)

infix fun ClassLoader.findOrNull(name: String?): Class<*>? = findClassIfExists(name, this)
